...
# Deploy Expense Management Application (with GenAI)
# This script deploys everything including Azure OpenAI for the chat UI

set -e  # Exit on any error

echo "======================================"
echo "Expense Management Deployment (with AI Chat)"
echo "======================================"
echo ""
...
LOCATION="uksouth"
DEPLOYMENT_NAME="expensemgmt-genai-deployment-$(date +%s)"
...
echo "Deploying infrastructure (App Service, Managed Identity, Azure SQL, Azure OpenAI)..."
...
echo "  OpenAI Model Name: $OPENAI_MODEL_NAME"
echo ""
...
# Configure App Service settings (INCLUDING OpenAI settings)
...
echo ""
echo "✅ Full AI chat features are enabled!"
echo "   You can interact with your expense data using natural language."
echo ""
